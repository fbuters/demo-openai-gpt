...
def record_from_microphone(duration:int, sample_freq:int = 44100,):
    ...
    recording = sd.rec(int(duration * sample_freq), samplerate=sample_freq, channels=1,)
    sd.wait()
...
if __name__ == "__main__":
    ...
    st.header("Demo OpenAI and more")
